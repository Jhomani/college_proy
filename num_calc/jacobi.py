...
if(len(a) == 2):
  while(er > target_er):
    ...
    xk2 = my_round((1/a[1][1])*(a[1][2] - a[1][0]*x1k), 5)
    ...
    print(f'(1/{a[1][1]})*({a[1][2]} - {a[1][0]}*{x1k}) = {xk2}')
...
if(len(a) == 3):
  while(er > target_er):
    ...
    xk2 = my_round((1/a[1][1])*(a[1][3] - a[1][0]*x1k - a[1][2]*x3k), 5)
    xk3 = my_round((1/a[2][2])*(a[2][3] - a[2][0]*x1k - a[2][1]*x2k), 5)
    ...
    print(f'(1/{a[1][1]})*({a[1][3]} - {a[1][0]}*{x1k} - {a[1][2]}*{x3k}) = {xk2}')
    print(f'(1/{a[2][2]})*({a[2][3]} - {a[2][0]}*{x1k} - {a[2][1]}*{x2k}) = {xk3}')
    print(f'error = {er} k = {k}')
